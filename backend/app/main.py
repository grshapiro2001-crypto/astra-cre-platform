...
from app.api.routes import auth, upload, properties, deal_folders, scoring, data_bank, criteria, chat, organizations, stacking, assistant, admin, feedback, events, underwriting, t12_mapping, waitlist, saved_comparisons
