...
from app.api.routes import auth, upload, properties, deal_folders, scoring, data_bank, criteria, chat, organizations, stacking, assistant, admin, feedback, events, underwriting, underwriting_export, t12_mapping, waitlist, saved_comparisons
...
app.include_router(underwriting_export.router, prefix="/api/v1")
app.include_router(t12_mapping.router, prefix="/api/v1")
app.include_router(waitlist.router, prefix="/api/v1")
app.include_router(saved_comparisons.router, prefix="/api/v1")
