...
{{
  ...
  "buildings": [
    {{
      "id": "A",
      "label": "Building A",
      "shape": "linear|L|U|courtyard|tower|wrap",  // linear=simple rectangle, L=two connected wings at 90deg, U=three wings open on one side, courtyard=four wings enclosing a center area, wrap=three or more wings partially enclosing an area, tower=tall single footprint
      "num_floors": 3,
      "units_per_floor": 8,
      "wings": [
        {{
...
- Year built and style matter: {year_built} — newer urban properties tend to be single connected structures.
